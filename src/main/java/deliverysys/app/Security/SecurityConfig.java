...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        if ("prod".equals(activeProfile)) {
            ...
            .requestMatchers("/", "/index.html", "/static/**", "/assets/**", "/favicon.ico", "/login", "/dashboard", "/orders", "/assignments", "/delivery-persons").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:5173","https://soothing-curiosity-new.up.railway.app"));
